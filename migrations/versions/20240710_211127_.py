...
Revision ID: 3df2d3184faf
Revises: ffdc0a98111c
Create Date: 2024-07-10 21:11:27.255180
...
def upgrade():
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.ForeignKeyConstraint(['admission_id'], ['admission_tickets.id'], ),
    ...
    sa.Column('quantity', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['purchase_id'], ['admission_ticket_purchases.id'], ),
    sa.ForeignKeyConstraint(['type_id'], ['admission_ticket_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    if environment == "production":
